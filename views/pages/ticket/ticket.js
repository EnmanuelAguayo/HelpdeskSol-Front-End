...
const pushContent = async () => {
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0"><i class="nav-icon fas fa-clock"></i> Historial del Ticket</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Home</a></li>
            <li class="breadcrumb-item">Servicios</li>
            <li class="breadcrumb-item active">Historial del Ticket</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <h3>
          <strong>
            <span class="badge badge-pill badge-success">
              #Ticket 421374 - Antivirus vencido
            </span>
          </strong>
        </h3>
          ...
          <div class="row">
            <div class="col-sm-6 col-md-6 col-lg-6 col-lx-6">
              <div class="row">
                ...
                <div class="col-6 mb-2">
                  Emisi&oacute;n de p&oacute;lizas
                </div>
                <!-- list-group -->
                <div class="col-6 mb-2">
                ...
                <div class="col-6 mb-2">
                  22 de set / 9:00 <i class="fas fa-clock"></i>
                </div>
              </div>
            </div>
            <!-- /. left -->
